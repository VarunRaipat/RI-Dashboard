...
def init_db():
    ...
    CREATE TABLE IF NOT EXISTS orders (
        ...
        transport_gst_applicable INTEGER DEFAULT 0,
    ...
    CREATE TABLE IF NOT EXISTS rm_prices (
        ...
        concrete REAL DEFAULT 3500, steel REAL DEFAULT 0,
        created_at TEXT DEFAULT (datetime('now','localtime'))
    );
    ...
    for table, col, decl in [
        ...
        ("orders", "transport_mode", "TEXT DEFAULT 'per_unit'"),
        ("orders", "transport_rate", "REAL DEFAULT 0"),
        ("orders", "transport_value", "REAL DEFAULT 0"),
        ("orders", "transport_gst_applicable", "INTEGER DEFAULT 0"),
        ("orders", "transport_gst_amount", "REAL DEFAULT 0"),
        ("dispatch", "transport_mode", "TEXT DEFAULT 'per_unit'"),
        ("dispatch", "transport_rate", "REAL DEFAULT 0"),
